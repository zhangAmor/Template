...
<form class="layui-form layui-form-pane" onsubmit="return false;">
    ...
    <div class="layui-form-item mos-common-margin-bottom0">
        <div class="layui-input-block mos-common-margin-left0">
            <button class="layui-btn" lay-submit="" lay-filter="mos-common-btn-table-search" data-tableid="mos-table-recharge">搜索</button>
            <button type="reset" class="layui-btn layui-btn-primary">重置</button>
            <button class="layui-btn layui-btn-primary mos-common-btn-table-refresh" data-tableid="mos-table-recharge" data-page="current" title="刷新"><i class="layui-icon layui-icon-refresh-3"></i></button>
        </div>
    </div>
</form>

<!-- 数据列表 -->
<table id="mos-table-recharge" lay-filter="mos-table" data-url="<?php echo Html::encode(Url::to(['my/recharge'])); ?>"></table>